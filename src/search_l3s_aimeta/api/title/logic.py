...
class Title(Text_Preprocess,object):
    ...
    @classmethod
    def generate_title(self, id):

        user_message = "Schlage für nachfolgende Lerneinheit drei motivierende Titel im JSON Format vor. Format: [<titel>, <titel>, ...]"
 

        system_messages = "Sie sind ein hilfreicher Assistent, der motivierende Titel für eine bestimmte Lerneinheit erstellt."
